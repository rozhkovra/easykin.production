...
<%
	...
	String urlParameters = "session="+session.getId()+"&statusId="+statusId+"&priorityId="+priorityId+"&moduleId="+moduleId;
	...
	%><td style="<%=tdStyle%>"><a href="index.jsp?<%=urlParameters%>">Все</a> <b>(<%=tasks.size()%>)</b></td><%
